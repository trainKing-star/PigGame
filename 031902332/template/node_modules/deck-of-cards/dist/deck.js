    ...
    card: function card(_card6) {
      ...
      _card6.fan = function (i, len, cb) {
        ...
        _card6.animateTo({
          ...
          x: Math.cos(deg2rad(rot - 90)) * 120 * _fontSize / 16,
          y: Math.sin(deg2rad(rot - 90)) * 120 * _fontSize / 16,
          rot: rot,
    ...
    card: function card(_card7) {
      ...
      _card7.bysuit = function (cb) {
        ...
        _card7.animateTo({
          ...
          x: -Math.round((6.75 - rank) * 6 * ___fontSize / 16),
          y: -Math.round((1.5 - suit) * 80 * ___fontSize / 16),
          rot: -90,
