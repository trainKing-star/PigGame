$(document).ready(function(){
            ...
            function AI_action() {
                ...
                deck_container.cards.forEach(function (card) {
                    ...
                    if(card.$root != null && card.$el.className === "card"){
                        data_dict["pokers_total"] += 1;
                        data_dict["pokers_" + card.suit] += 1;
                    }
                    else if(card.$el.id === "show"){
            ...
            function player_one_init(player) {
                ...
                deck.mount($label);
                let more = null;
                if(player === "player1" && player2 != null) more = player2;
                else if(player === "player2" && player1 != null) more = player1;
